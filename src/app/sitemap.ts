...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = [
    ...
    { path: "/blog/signal-based-outbound", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/blog/koude-acquisitie-naar-signal-based-outbound", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/blog/koopsignalen-b2b-outbound", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/blog/tools-signal-based-outbound", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/blog/intent-data-nederland-mkb", priority: 0.6, changeFrequency: "monthly" as const },
