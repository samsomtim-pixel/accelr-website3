...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogSignalBased.metadata" });

  return {
    alternates: buildAlternates("/blog/signal-based-outbound", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/signal-based-outbound", locale),
