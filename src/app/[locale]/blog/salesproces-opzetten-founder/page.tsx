...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogSalesproces.metadata" });

  return {
    alternates: buildAlternates("/blog/salesproces-opzetten-founder", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/salesproces-opzetten-founder", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  const t = await getTranslations("blogSalesproces");
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "salesproces-opzetten-founder", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/salesproces-opzetten-founder" }], __locale)]} />
      <Navbar />
