...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogUitbesteden.metadata" });

  return {
    alternates: buildAlternates("/blog/sales-uitbesteden-of-zelf-doen", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/sales-uitbesteden-of-zelf-doen", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  const t = await getTranslations("blogUitbesteden");
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "sales-uitbesteden-of-zelf-doen", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/sales-uitbesteden-of-zelf-doen" }], __locale)]} />
      <Navbar />
