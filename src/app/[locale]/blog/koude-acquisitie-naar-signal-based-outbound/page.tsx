...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogKoudeAcquisitie.metadata" });

  return {
    alternates: buildAlternates("/blog/koude-acquisitie-naar-signal-based-outbound", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/koude-acquisitie-naar-signal-based-outbound", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "koude-acquisitie-naar-signal-based-outbound", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/koude-acquisitie-naar-signal-based-outbound" }], __locale)]} />
      <Navbar />
