...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogHubspot.metadata" });

  return {
    alternates: buildAlternates("/blog/hubspot-vs-pipedrive-mkb", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/hubspot-vs-pipedrive-mkb", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  const t = await getTranslations("blogHubspot");
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "hubspot-vs-pipedrive-mkb", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/hubspot-vs-pipedrive-mkb" }], __locale)]} />
      <Navbar />
