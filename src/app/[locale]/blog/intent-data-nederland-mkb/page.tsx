...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogIntentData.metadata" });

  return {
    alternates: buildAlternates("/blog/intent-data-nederland-mkb", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/intent-data-nederland-mkb", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "intent-data-nederland-mkb", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/intent-data-nederland-mkb" }], __locale)]} />
      <Navbar />
