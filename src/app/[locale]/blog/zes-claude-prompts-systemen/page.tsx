...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "blogClaudePrompts.metadata" });

  return {
    alternates: buildAlternates("/blog/zes-claude-prompts-systemen", locale),
    title: t("title"),
    description: t("description"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: pageUrl("/blog/zes-claude-prompts-systemen", locale),
...
export default async function BlogPost({ params }: { params: Promise<{ locale: string }> }) {
  const t = await getTranslations("blogClaudePrompts");
  ...
  return (
    <>
      <JsonLd data={[blogPostingSchema({ slug: "zes-claude-prompts-systemen", headline: t("metadata.title"), description: t("metadata.description"), locale: __locale }), breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: t("metadata.title"), path: "/blog/zes-claude-prompts-systemen" }], __locale)]} />
      <Navbar />
