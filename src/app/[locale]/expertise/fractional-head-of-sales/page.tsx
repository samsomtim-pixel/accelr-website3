...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "fractional" });

  return {
    alternates: buildAlternates("/expertise/fractional-head-of-sales", locale),
    title: t("metadata.title"),
    description: t("metadata.description"),
    openGraph: {
      title: t("metadata.title"),
      description: t("metadata.description"),
      url: pageUrl("/expertise/fractional-head-of-sales", locale),
