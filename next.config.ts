...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' assets.calendly.com assets.apollo.io",
      "style-src 'self' 'unsafe-inline' fonts.googleapis.com",
      "font-src 'self' fonts.gstatic.com",
      "frame-src calendly.com",
      "img-src 'self' data: blob: o.apollo.io",
      "connect-src 'self' calendly.com assets.calendly.com vitals.vercel-insights.com assets.apollo.io app.apollo.io o.apollo.io api.apollo.io",
